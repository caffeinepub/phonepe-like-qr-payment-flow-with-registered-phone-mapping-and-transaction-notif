...
export class Backend implements backendInterface {
    ...
    async createTransaction(arg0: Principal, arg1: bigint, arg2: string): Promise<Transaction> {
        if (this.processError) {
            try {
    ...
    async sendQRScanNotification(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendQRScanNotification(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
